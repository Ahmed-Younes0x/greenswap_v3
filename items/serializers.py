...
class ItemListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'title', 'description', 'price', 'quantity', 'condition', 'location', 
                 'status', 'is_featured', 'is_urgent', 'owner', 'category_name', 'primary_image', 
...
class ItemDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'title', 'description', 'category', 'owner', 'price', 'quantity', 
                 ...
                 'rating_average', 'rating_count', 'images', 'ratings', 'is_liked', 'can_edit']
...
class ItemCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Item
        fields = ['title', 'description', 'category', 'price', 'quantity', 'is_negotiable', 
